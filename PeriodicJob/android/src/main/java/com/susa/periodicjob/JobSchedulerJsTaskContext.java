...
public class JobSchedulerJsTaskContext {

    private static final WeakHashMap<ReactContext, JobSchedulerJsTaskContext> INSTANCES =
            new WeakHashMap<>();
     ...
     */
    public static JobSchedulerJsTaskContext getInstance(ReactContext context) {
        JobSchedulerJsTaskContext helper = INSTANCES.get(context);
        if (helper == null) {
            helper = new JobSchedulerJsTaskContext(context);
    ...
    private JobSchedulerJsTaskContext(ReactContext reactContext) {
     ...
     */
    public synchronized int startTask(final JobSchedulerJsTaskConfig taskConfig, int taskId) {
